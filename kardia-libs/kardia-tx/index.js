...
var Transaction = function () {
  ...
  Transaction.prototype.kardiaSerialize = function kardiaSerialize() {
    return rlp.encode(this.raw.slice(0, 6));
  }
  ...
  Transaction.prototype.verifySignature = function verifySignature() {
    ...
    try {
      ...
      console.log('sender public key', this._senderPubKey.toString('hex'))
    } catch (e) {
      return false;
    }
