...
const explorerLinks = require('../../../kardia-libs/kai-net-props').explorerLinks
...
export default class ExtensionPlatform {
  ...
  _showNotification (title, message, url) {
    extension.notifications.create(url, {
      type: 'basic',
      title,
      iconUrl: extension.extension.getURL('../../images/kardia/logo_with_bg.png'),
      message,
    })
  }
  ...
  _getExplorer (hash, networkId) {
    const explorerName = 'KardiaChain Explorer'
