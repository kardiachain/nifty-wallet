...
function injectScript (content) {
  try {
    ...
    console.error('KardiaChain Wallet injection failed.', error)
  }
}
...
async function setupStreams () {
  ...
  pump(pageMux, pageStream, pageMux, (err) =>
    logStreamDisconnectWarning('KardiaChain Wallet Inpage Multiplex', err),
  )
  pump(extensionMux, extensionStream, extensionMux, (err) => {
    logStreamDisconnectWarning('KardiaChain Wallet Background Multiplex', err)
  ...
  pump(
    ...
    extensionStream,
    pageStream,
    (err) => logStreamDisconnectWarning('KardiaChain Wallet Contentscript Forwarding', err),
  )
  ...
  pump(legacyPageMux, legacyPageStream, legacyPageMux, (err) =>
    logStreamDisconnectWarning('KardiaChain Wallet Legacy Inpage Multiplex', err),
  )
  pump(
    legacyExtensionMux,
    extensionStream,
    ...
    legacyExtensionMux,
    (err) => {
      logStreamDisconnectWarning('KardiaChain Wallet Background Legacy Multiplex', err)
      notifyInpageOfStreamFailure()
    },
  )
...
function redirectToPhishingWarning () {
  console.log('KardiaChain Wallet - routing to Phishing Warning component')
