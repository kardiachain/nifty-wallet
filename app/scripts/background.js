...
async function initialize () {
  ...
  log.debug('KardiaChain Wallet initialization complete.')
}
...
function setupController (initState, initLangCode) {
  ...
  const controller = new MetamaskController({
    ...
    infuraProjectId: '1f03910a1fa3406dbf37a3e2c2fef867',
    // ethMainnetRpcEndpoint: process.env.ETH_MAINNET_RPC_ENDPOINT,
    ethMainnetRpcEndpoint: 'https://mainnet.infura.io/v3/1f03910a1fa3406dbf37a3e2c2fef867',
